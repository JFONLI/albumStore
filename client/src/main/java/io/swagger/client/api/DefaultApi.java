...
//    }
    ...
    public ApiResponse<AlbumInfo> getAlbumByKey(String albumID) throws ApiException {
        ApiResponse<AlbumInfo> resp = getAlbumByKeyWithHttpInfo(albumID);
        return resp;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ImageMetaData> newAlbum(File image, AlbumsProfile profile) throws ApiException {
